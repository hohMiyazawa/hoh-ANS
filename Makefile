...
all: choh dhoh simple_entropy_encoder simple_entropy_decoder layer_roundtrip_test tests
...
layer_roundtrip_test: layer_roundtrip_test.cpp rans64.hpp entropy_encoding.hpp entropy_decoding.hpp varint.hpp stattools.hpp layer_encode.hpp layer_decode.hpp
	g++ -o $@ $< -O3 $(LIBS)

tests: pre_tests entropy_roundtrip rgb_roundtrip layer_roundtrip
...
layer_roundtrip: layer_roundtrip_test
	@./layer_roundtrip_test
